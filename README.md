...
Seven distinct missingness scenarios required resolution before analysis could begin. Each was handled on its own terms rather than through uniform imputation.
...
<h3 align="left">Education level is the strongest demographic risk signal</h3>
...
<h3 align="left">Age and regional risk tier are the two most reliable standalone risk indicators</h3>

Age declines without exception from **11.47%** among borrowers in their 20s (44,738 records) to **4.92%** among borrowers 60 and older (35,665 records), with every cohort lower than the one before it. Regional risk tiers follow the same pattern, scaling from **4.82%** in Low Risk regions (32,197 records) to **11.10%** in High Risk regions (48,330 records), **6.28** percentage point spread across three tiers with no outlier breaking the sequence.

<h3 align="left">DTI above 0.20 is the actionable financial threshold</h3>
...
<h3 align="left">Income tier alone is an unreliable standalone predictor</h3>
...
<h3 align="left">Housing instability is a stronger default driver than employment status</h3>
...
<h3 align="left">Employer industry type is a meaningful and underutilized risk signal</h3>
